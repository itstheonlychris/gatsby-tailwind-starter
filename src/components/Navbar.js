  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-white border-b border-gray-200 font-body p-6">
      ...
      <div className="block lg:hidden">
        <button className="flex items-center px-3 py-2 border rounded text-purple-700 border-purple-400 hover:text-purple-900 hover:bg-purple-200 hover:border-purple-900">
          <svg
